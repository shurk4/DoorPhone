/**
    На клиенте:
        Сделать таймер ожидания пинга от сервера. При получении запроса true, при отправке ответа false.
            Сделать таймер с таймаутом болше времени пинга сервера и обнулением при запросе
